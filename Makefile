...
VERILATOR_ROOT := ~/local/share/verilator/
...
libfoo.so: foo_impl.sv foo.cpp tb_obj_dir/Vfoo_tb__Dpi.h
	verilator --trace --cc foo_impl.sv -CFLAGS '-fPIC'
...
tb_obj_dir/Vfoo_tb__Dpi.h: foo_tb.sv foo.sv tb.cpp
	verilator --trace --exe foo_tb.sv foo.sv --top-module foo_tb --Mdir tb_obj_dir tb.cpp --cc
